...
import {MAIN_BACKGROUND_COLOR, INACTIVE_INPUT_BORDER_COLOR, INACTIVE_INPUT_FONT_COLOR, INACTIVE_INPUT_COLOR} from '../constants/color';
import {AUTH_RADIO_SIZE} from '../constants/fontSize';
    ...
    <Section>
      ...
      <AuthBox>
        ...
        <WrapContents>
          ...
          <NormalButton type="button">회원가입</NormalButton>
        </WrapContents>
      </AuthBox>  
    </Section>
  )
